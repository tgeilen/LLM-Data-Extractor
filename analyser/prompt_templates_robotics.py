...
18. Architecture — Select **one** from the following standardized list (do not invent or paraphrase):
[
...
19. Task — List of specific tasks the model is designed for (e.g., "code generation", "language modeling/generation", "chat", "visual question answering", "translation", "quantitative reasoning", "question answering", "text summarization", "speech recognition", "video description", "character recognition", "instruction interpretation", "video generation", "image-to-video", "mathematical reasoning")

## Additional Robotics-Specific Fields

20. Robot Type — one or more of:
[
  "humanoid",
  "quadruped",
  "drone",
...
21. Sensor Modalities — one or more of:
[
  "RGB camera",
  "depth camera",
  "LIDAR",
...
22. Control Type — one or more of:
[
  "low-level control",
  "mid-level planning",
  "high-level planning",
...
23. Sim2Real Transfer — indicate `"yes"` or `"no"` with optional details, e.g., `"yes (trained in simulation, fine-tuned on real robot)"`

24. Environment Types — one or more of:
[
  "household",
  "industrial",
  "outdoor",
...
25. Policy Representation — one or more of:
[
  "transformer policy",
  "diffusion policy",
...
[
  {
    ...
    "robot_type": {
      "value": [<<list of robot types or "n/a">>],
      "confidence": <<integer 0–100>>,
      "references": "<<section name or quote>>"
    },
    "sensor_modalities": {
      "value": [<<list of sensor modalities or "n/a">>],
      "confidence": <<integer 0–100>>,
      "references": "<<section name or quote>>"
    },
    "control_type": {
      "value": [<<list of control types or "n/a">>],
      "confidence": <<integer 0–100>>,
      "references": "<<section name or quote>>"
    },
    "sim2real_transfer": {
      "value": "<<yes/no with optional details or n/a>>",
      "confidence": <<integer 0–100>>,
      "references": "<<section name or quote>>"
    },
    "environment_types": {
      "value": [<<list of environment types or "n/a">>],
      "confidence": <<integer 0–100>>,
      "references": "<<section name or quote>>"
    },
    "policy_representation": {
      "value": [<<list of policy representations or "n/a">>],
      "confidence": <<integer 0–100>>,
      "references": "<<section name or quote>>"
    }
  }
